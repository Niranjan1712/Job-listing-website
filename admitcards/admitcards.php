...
.display{
  ...
  height:550px;
    ...
    <title>Get Into Job - Admit Card</title>
  </head>
  <body>
...
<table class="table table-bordered dis">
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #4A148C;" class=" text-center" colspan="6">Admit Cards</td>
    </tr>
    ...
    <tr style="background-color: #CE93D8;" class="text-center">
...
$sql = "SELECT jobname, deptname FROM admitcards order by id desc";
...
<form method="post" action="admitcards.php">
...
<td style="padding-top: 24px;">
  <button style="background-color: #CE93D8;" type="submit" class="btn" name ="click">Check</button>
</td>
</form>
</tr>
...
<table class="table table-bordered dis">
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #4A148C;" class=" text-center" colspan="6">February 2020</td>
    </tr>
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #4A148C;" class=" text-center" colspan="6">January 2020</td>
    </tr>
...
<table class="table table-bordered dis1">
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #4A148C;" class=" text-center" colspan="6">Latest Admit Cards</td>
    </tr>
    <tr style="background-color: #8E44AD;">
