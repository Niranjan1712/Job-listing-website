...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-2 dis">
            <img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image">
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #0D47A1;" class=" text-center" colspan="6">Latest Jobs 2020</td>
    </tr>
     <tr style="background-color: #5DADE2;">
      
      <td style="height: 10px;  padding: 5px; color: white;" class=" text-center" colspan="6">March 2020</td>
    </tr>
    <tr style="background-color: #AED6F1;" class="text-center">
...
$sql = "SELECT jobname, deptname, date1, date2 FROM jobs order by id desc";
...
<td style="padding-top: 24px;">
  <button style="background-color: #5DADE2;" type="submit" class="btn" name ="click">Check</button>
</td>
</form>
</tr>
...
<table class="table table-bordered dis">
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #0D47A1;" class=" text-center" colspan="6">February 2020</td>
    </tr>
    ...
    <tr style="background-color: #AED6F1;" class="text-center">
      ...
      <?php
$conn = mysqli_connect('sql207.epizy.com', 'epiz_25468334', 'Wog8pxAxXt', 'epiz_25468334_feb2020','3306');
// Check connection
if ($conn->connect_error) {
die("Connection failed: " . $conn->connect_error);
}
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #0D47A1;" class=" text-center" colspan="6">January 2020</td>
    </tr>
