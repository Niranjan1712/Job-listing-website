...
.display{
  ...
  height:550px;
    ...
    <title>Get Into Job - Answer Key Details</title>
  </head>
  <body>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div style="padding-left: 5px; padding-right: 5px;" class="col-sm-8">
        ...
        <?php
           ...
           $query = "SELECT * FROM answerkeys WHERE jobname='$value' ";
  ...
  <thead>
    <tr>
      <th style="color: white; background-color: #E12B38;" colspan="4" scope="col">Department Name <span>&#8628;</span></th>
  ...
  <tbody>
    ...
    <tr>
      <th style="color: white; background-color: #E12B38;" colspan="4" scope="col">Job Name <span>&#8628;</span></th>
    ...
    <tr>
      <th style="color: white; background-color: #E12B38;" colspan="4" scope="col">Important Dates<span>&#8628;</span></th>
    ...
    <tr>
      <th style="color: white; background-color: #E12B38;" colspan="4" scope="col">Answer Key<span>&#8628;</span></th>
