<?php 
	...
	// connect to database
	$db = mysqli_connect('sql207.epizy.com', 'epiz_25468334', 'Wog8pxAxXt', 'epiz_25468334_april2020','3306');
	...
	if (isset($_POST['submit'])) {
		...
		$linkname6 = mysqli_real_escape_string($db, $_POST['linkname6']);
		$linkname7 = mysqli_real_escape_string($db, $_POST['linkname7']);
		$linkname8 = mysqli_real_escape_string($db, $_POST['linkname8']);
        $linkname9 = mysqli_real_escape_string($db, $_POST['linkname9']);
		$linkname10 = mysqli_real_escape_string($db, $_POST['linkname10']);
		...
		$linkvalue6 = mysqli_real_escape_string($db, urldecode($_POST['linkvalue6']));
		$linkvalue7 = mysqli_real_escape_string($db, urldecode($_POST['linkvalue7']));
		$linkvalue8 = mysqli_real_escape_string($db, urldecode($_POST['linkvalue8']));
        $linkvalue9 = mysqli_real_escape_string($db, urldecode($_POST['linkvalue9']));
		$linkvalue10 = mysqli_real_escape_string($db, urldecode($_POST['linkvalue10']));
...
/*
		...
		if (count($errors) == 0) {
			...
			$query = "INSERT INTO results (deptname, jobname, date1, date2, date3, date4, linkname1, linkname2, linkname3, linkname4, linkname5, linkname6, linkname7, linkname8, linkname9, linkname10, linkvalue1, linkvalue2, linkvalue3, linkvalue4, linkvalue5, linkvalue6, linkvalue7, linkvalue8, linkvalue9, linkvalue10) 
					  VALUES('$deptname', '$jobname', '$date1', '$date2', '$date3', '$date4','$linkname1', '$linkname2', '$linkname3', '$linkname4', '$linkname5', '$linkname6', '$linkname7', '$linkname8', '$linkname9', '$linkname10', '$linkvalue1', '$linkvalue2', '$linkvalue3', '$linkvalue4', '$linkvalue5', '$linkvalue6', '$linkvalue7', '$linkvalue8','$linkvalue9', '$linkvalue10')";
