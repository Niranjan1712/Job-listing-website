...
.display{
  ...
  height:550px;
    ...
    <title>Get Into Job - Answer Key</title>
  </head>
  <body>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-2  dis">
            <img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image"><img src="../img/postf3.jpg" class="img-fluid" alt="Responsive image">
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #E12B38;" class=" text-center" colspan="6">Latest Answer Keys</td>
    </tr>
    ...
    <tr style="background-color: #F1948A;" class="text-center">
...
$sql = "SELECT jobname, deptname FROM answerkeys order by id desc";
...
<form method="post" action="answerkeys.php">
...
<td style="padding-top: 24px;">
  <button style="background-color: #F1948A;" type="submit" class="btn" name ="click">Check</button>
</td>
</form>
</tr>
...
<table class="table table-bordered dis">
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #E12B38;" class=" text-center" colspan="6"> Before April 2020</td>
    </tr>
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #E12B38;" class=" text-center" colspan="6">February 2020</td>
    </tr>
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td style="color: white; background-color: #E12B38;" class=" text-center" colspan="6">January 2020</td>
    </tr>
