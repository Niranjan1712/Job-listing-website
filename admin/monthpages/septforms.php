...
<div class="container-fluid">
  ...
  <h4 class="text-center">September Forms</h4>
  ...
  <div class="card-body">
    ...
    <a href="../../forms/septforms/jobs/jobform.php" class="btn btn-primary">Fill Form Now</a>
  </div>
...
<div style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="../../forms/septforms/admitcards/admitcardform.php" class="btn btn-primary">Fill Form Now</a>
  </div>
  <div class="card-footer text-muted">
...
<div style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="../../forms/septforms/answerkey/answerkeyform.php" class="btn btn-primary">Fill Form Now</a>
  </div>
  <div class="card-footer text-muted">
...
<div  class="card text-center">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="../../forms/septforms/results/resultform.php" class="btn btn-primary">Fill Form Now</a>
  </div>
  <div class="card-footer text-muted">
