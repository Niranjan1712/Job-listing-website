...
.display{
  ...
  height:550px;
    ...
    <title>Get Into Job - Admit Card Details</title>
  </head>
  <body>
...
<section style="margin-top: 80px;" >
              <div   style="margin-top: 0px;" class="container-fluid text-center text-center">
        <div  class="row">
...
<div class="container-fluid">
  <div class="row">
    ...
    <div style="padding-left: 5px; padding-right: 5px;" class="col-sm-8">
        ...
        <?php
           ...
           $query = "SELECT * FROM admitcards WHERE jobname='$value' ";
  ...
  <thead>
    <tr>
      <th style="color: white; background-color: #4A148C;" colspan="4" scope="col">Department Name <span>&#8628;</span></th>
  ...
  <tbody>
    ...
    <tr>
      <th style="color: white; background-color: #4A148C;" colspan="4" scope="col">Job Name <span>&#8628;</span></th>
    ...
    <tr>
      <th style="color: white; background-color: #4A148C;" colspan="4" scope="col">Important Dates<span>&#8628;</span></th>
    ...
    <tr>
      <th style="color: white; background-color: #4A148C;" colspan="4" scope="col">Download Links<span>&#8628;</span></th>
