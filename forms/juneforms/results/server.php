<?php 
	...
	// connect to database
	$db = $db = mysqli_connect('sql207.epizy.com', 'epiz_25468334', 'Wog8pxAxXt', 'epiz_25468334_june2020','3306');
...
/*
		...
		if (count($errors) == 0) {
			...
			$query = "INSERT INTO results (deptname, jobname, date1, date2, date3, date4, linkname1, linkname2, linkname3, linkname4, linkvalue1, linkvalue2, linkvalue3, linkvalue4) 
