...
<section style="margin-bottom: 80px;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item fun">
              <a style="color: white; padding-right: 20px; padding-left: 20px;" class="nav-link" href="adminlogin.php?logout='1'">Logout</a>
            </li>
          </ul>
...
<div class="container-fluid">
  ...
  <div class="card-body">
    <h5 class="card-title">January Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/janforms.php" class="btn btn-primary">Click Here</a>
  </div>
...
<div style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">February Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/febforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">March Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/marchforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">April Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/aprilforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">May Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/mayforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">June Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/juneforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">July Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/julyforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">August Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/augforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">September Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/septforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">October Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/octforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">November Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/novforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
...
<div  style="margin-bottom: 20px;" class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">December Month forms</h5>
    <p class="card-text">Fill the form carefully ! and leave fields empty which are unknown.</p>
    <a href="monthpages/decforms.php" class="btn btn-primary">Click Here</a>
  </div>
  <div class="card-footer text-muted">
