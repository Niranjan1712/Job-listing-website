...
.display{
  ...
  height:550px;
    ...
    <title>Get Into Job - Admin Login</title>
  </head>
  <body>
...
<div class="container-fluid">
  <div class="row">
    ...
    <img   src="../img/postf3.jpg" class="img-fluid" alt="Responsive image">
    <!-- Place for Add-->
  </div>
  ...
  <thead>
    <tr>
      <td style="background-color: #0D47A1;" class=" text-center" colspan="4" scope="col"><a style="color: white;" href="">Admin Login</a></td>
    </tr>
  </thead>
 
</table>

     <form method="post" action="adminlogin.php" class="text-center">
      <?php include('errors.php'); ?>
  <div class="form-group" style="margin-bottom: 30px;">
    <input style="height: 50px;" type="text" class="form-control text-center" name="username" placeholder="username" >
    
  </div>
  <div class="form-group">
    <input style="height: 50px;" type="password" class="form-control text-center" name="password" placeholder="Password">
  </div><br>
