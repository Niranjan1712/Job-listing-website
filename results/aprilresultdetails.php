    ...
    <tr>
     ...
     <?php
      ...
      if($row["linkname5"]!=null){
          ...
          <td  colspan = \"2\"><a href='".$row['linkvalue5']."'><button>Click Here</button></a></td>
          </tr>";
          }     
     if($row["linkname6"]!=null){
                 print "<tr>
          <td  colspan = \"2\">" . $row['linkname6'] . "</td>
          <td  colspan = \"2\"><a href='".$row['linkvalue6']."'><button>Click Here</button></a></td>
          </tr>";
          }
     if($row["linkname7"]!=null){
                 print "<tr>
          <td  colspan = \"2\">" . $row['linkname7'] . "</td>
          <td  colspan = \"2\"><a href='".$row['linkvalue7']."'><button>Click Here</button></a></td>
          </tr>";
          }
     
     if($row["linkname8"]!=null){
                 print "<tr>
          <td  colspan = \"2\">" . $row['linkname8'] . "</td>
          <td  colspan = \"2\"><a href='".$row['linkvalue8']."'><button>Click Here</button></a></td>
          </tr>";
          }

     if($row["linkname9"]!=null){
                 print "<tr>
          <td  colspan = \"2\">" . $row['linkname9'] . "</td>
          <td  colspan = \"2\"><a href='".$row['linkvalue9']."'><button>Click Here</button></a></td>
          </tr>";
          }
     if($row["linkname10"]!=null){
                 print "<tr>
          <td  colspan = \"2\">" . $row['linkname10'] . "</td>
          <td  colspan = \"2\"><a href='".$row['linkvalue10']."'><button>Click Here</button></a></td>
          </tr>";
          }
        ?>
