...
.display{
  ...
  height:550px;
    ...
    <title>Get Into Job - Result Update Form</title>
  </head>
  <body>
...
<div class="container-fluid">
  ...
  <tbody>
    <tr >
      ...
      <td style="color: white;" class="navbar-dark bg-primary text-center" colspan="2"><h5>Results Update Form</h5></td>
    </tr>
  ...
  <div class="row">
    <div class="col">
      <label for="exampleInputPassword1">Link Name 6</label>
      <input type="text" class="form-control" name="linkname6">
    </div>
    <div class="col">
      <label for="exampleInputPassword1">Link Value 6</label>
      <input type="text" class="form-control" name="linkvalue6">
    </div>
  ...
  <div class="row">
    <div class="col">
      <label for="exampleInputPassword1">Link Name 7</label>
      <input type="text" class="form-control" name="linkname7">
    </div>
    <div class="col">
      <label for="exampleInputPassword1">Link Value 7</label>
      <input type="text" class="form-control" name="linkvalue7">
    </div>
  ...
  <div class="row">
    <div class="col">
      <label for="exampleInputPassword1">Link Name 8</label>
      <input type="text" class="form-control" name="linkname8">
    </div>
    <div class="col">
      <label for="exampleInputPassword1">Link Value 8</label>
      <input type="text" class="form-control" name="linkvalue8">
    </div>
  ...
  <div class="row">
    <div class="col">
      <label for="exampleInputPassword1">Link Name 9</label>
      <input type="text" class="form-control" name="linkname9">
    </div>
    <div class="col">
      <label for="exampleInputPassword1">Link Value 9</label>
      <input type="text" class="form-control" name="linkvalue9">
    </div>
  ...
  <div class="row">
    <div class="col">
      <label for="exampleInputPassword1">Link Name 10</label>
      <input type="text" class="form-control" name="linkname10">
    </div>
    <div class="col">
      <label for="exampleInputPassword1">Link Value 10</label>
      <input type="text" class="form-control" name="linkvalue10">
    </div>
