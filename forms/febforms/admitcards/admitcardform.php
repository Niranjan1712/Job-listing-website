...
.display{
  ...
  height:550px;
    ...
    <title>Get Into Job - Admit Card Update Form</title>
  </head>
  <body>
...
<div class="container-fluid">
  ...
  <tbody>
    <tr >
      <h3 class="text-center">February</h3>
      <td style="color: white;" class="navbar-dark bg-primary text-center" colspan="2"><h5>Admit Card Update Form</h5></td>
    </tr>
    
  </tbody>
</table>

      <form  method="post" action="admitcardform.php">
